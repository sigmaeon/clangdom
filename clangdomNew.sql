...
CREATE  TABLE IF NOT EXISTS `clangdom`.`Source` (
  ...
  UNIQUE INDEX `Konto_UNIQUE` (`Konto` ASC) ,
...
-- -----------------------------------------------------
-- Table `clangdom`.`Message`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `clangdom`.`Message` ;

CREATE  TABLE IF NOT EXISTS `clangdom`.`Message` (
  ...
  UNIQUE INDEX `idNachricht_UNIQUE` (`idMessage` ASC) ,
